...
class ItemScrollController {
  ...
  void toBottom() => jumpTo(index: 0, alignment: 0);
...
class ScrollablePositionedListState<T extends ScrollablePositionedList> extends State<T> with TickerProviderStateMixin {
              ...
              PostMountCallback(
                ...
                child: FadeTransition(
                  ...
                  child: NotificationListener<ScrollNotification>(
                    onNotification: (_) => isTransitioning,
  ...
  void jumpTo({required int index, required double alignment}) {
